export default class HttpCode {
    ...
    static ERROR_LOGIN_USER_CREATED_CODE = 413;
    ...
    static ERROR_DATA_FORMAT_MSG = "Data format error";
    static ERROR_EMAIL_VERIFY_MSG = "Email verify error";
    static SUCCESS_MSG = "success";
    static ERROR_MSG = "Server Error";
    static ERROR_REQUEST_METHOD_MSG = "request method error";
    static ERROR_LOGIN_USER_CREATED_MSG = "by_user dont exist";
    static ERROR_LOGIN_USER_OR_PWD_MSG = "wrong with account or password";
    static ERROR_LOGIN_USER_NOT_EXISTS = "by_user does not exists";
